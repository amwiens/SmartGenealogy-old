...
{
    private Microsoft.UI.Xaml.Window? _appWindow;
    ...
    private bool TrySetMicaBackdrop()
    {
        ...
        this._appWindow.Activated += this.AppWindow_Activated;
        this._appWindow.Closed += this.AppWindow_Closed;

        // Initial configuration state.
        this.m_configurationSource.IsInputActive = true;

        if (this._appWindow.Content is FrameworkElement { ActualTheme: var actualTheme })
        {
        ...
        this.m_acrylicController.AddSystemBackdropTarget(this._appWindow.As<Microsoft.UI.Composition.ICompositionSupportsSystemBackdrop>());
    ...
    {
        if (this._appWindow is null || this.m_configurationSource is null)
        {
            return;
        }
        ...
        if (this._appWindow.Content is FrameworkElement frameworkElement)
        {
