using SmartGenealogy.Logging.Helpers;
...
public class Logger : ILoggerHost, IDisposable
{
    ...
    public void ReportEvent(string component, string subComponent, SeverityLevel severity, string message, Exception exception)
    {
