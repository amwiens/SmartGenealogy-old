...
public partial class SecondaryWindowExtension : WindowEx
{
    ...
    public void CenterAndElevateWindow()
    {
        ...
        {
            // first get a quarter of the size of the current window then get the center point
            // of the primary window. Subtract primary windows Y by a quarter of the secondary windows
            // Y to move the secondary window upwards. This will who the secondary window in the center
