...
public sealed partial class FeedbackPage : Page
{
    ...
    private async void DisplaySuggestFeature(object sender, RoutedEventArgs e)
    {
        ...
        if (result == ContentDialogResult.Primary)
        {
            ...
            var gitHubURL = "https://github.com/amwiens/SmartGenealogy/issues/new?title=" + issueTitle + "&labels=Issue-Feature&template=Feature_Request.yml&description=" + description + "&scenario=" + scenario + "&supportinginfo=" + supportingInfo;
    ...
    private async void DisplayLocalizationIssueDialog(object sender, RoutedEventArgs e)
    {
        ...
        if (result == ContentDialogResult.Primary)
        {
            ...
            var gitHubURL = "https://github.com/amwiens/SmartGenealogy/issues/new?title=" + issueTitle + "&labels=Issue-Translation&template=Translation_Issue.yml&version=" + version + "&languageaffected=" + languageAffected;
    ...
    private async void DisplayReportBugDialog(object sender, RoutedEventArgs e)
    {
        ...
        if (result == ContentDialogResult.Primary)
        {
            ...
            var gitHubURL = "https://github.com/amwiens/SmartGenealogy/issues/new?title=" + issueTitle + "&labels=Issue-Bug&template=Bug_Report.yml&version=" + version + "&windowsversion=" + windowsversion + "&repro=" + reproSteps + "&expectedbehavior=" + expectedBehavior + "&actualbehavior=" + actualBehavior + "&includedsysinfo=" + sysInfo + "&includedextensionsinfo=" + pluginsInfo + "&othersoftware=" + otherSoftware;
    ...
    {
        await Launcher.LaunchUriAsync(new ("https://github.com/amwiens/SmartGenealogy/security/policy"));
    }
}