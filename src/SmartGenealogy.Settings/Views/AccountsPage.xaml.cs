...
public sealed partial class AccountsPage : Page
{
    ...
    private async void AddAccountButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            var resourceLoader = new ResourceLoader(ResourceLoader.GetDefaultResourceFilePath(), "SmartGenealogy.Settings/Resources");
    ...
    private async Task ConfigureLoginUIRenderer(AdaptiveCardRenderer renderer)
    {
        ...
        try
        {
            var uri = new Uri($"ms-appx:////SmartGenealogy.Settings/Assets/{hostConfigFileName}");
